...
public class GreetingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("Salam", "Hello", R.raw.a));
        words.add(new Word("Sabahınız xeyir", "Good morning", R.raw.a));
        words.add(new Word("Hər vaxtınız xeyir", "Good afternoon", R.raw.a));
        words.add(new Word("Axşamınız xeyir", "Good evening", R.raw.a));;
        words.add(new Word("Gecəniz xeyirə qalsın", "Good night", R.raw.a));
        words.add(new Word("Necəsiz?", "How are you?", R.raw.a));
        words.add(new Word("Yaxşı", "Good", R.raw.a));
        words.add(new Word("Mən yaxşıyam", "I'm good", R.raw.a));
        words.add(new Word("Bəs siz?", "And you?", R.raw.a));
        words.add(new Word("Pis", "Bad", R.raw.a));

        WordAdapter itemsAdapter = new WordAdapter(this, words, R.color.color_greetings);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                // release media player if it was already created
                releaseMediaPlayer();
                ...
                if (audioFocus == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    mediaPlayer = MediaPlayer.create(GreetingsActivity.this, word.getmAudioResourceID());
